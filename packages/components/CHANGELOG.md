...
## [3.0.0](https://github.com/awslabs/iot-app-kit/compare/components-v2.6.5...components-v3.0.0) (2023-02-28)
...
* The following workspace dependencies were updated
  * dependencies
    * @iot-app-kit/core bumped from ^2.6.5 to ^3.0.0
    * @iot-app-kit/related-table bumped from ^2.6.5 to ^3.0.0
    * @iot-app-kit/source-iotsitewise bumped from ^2.6.5 to ^3.0.0
    * @iot-app-kit/table bumped from ^2.6.5 to ^3.0.0
